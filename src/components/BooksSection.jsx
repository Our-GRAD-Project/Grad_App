  ...
  return (
    <section className="w-full h-[916px] bg-white relative overflow-hidden">
      ...
      <p className="absolute top-[156px] left-[123px] w-[941px] text-[40px] leading-[50px] font-bold font-montserrat text-[#00000087]">
        We read the best books, highlight key ideas and insights, and create
        summaries fou you
      </p>
...
<img
      ...
      <footer className="absolute bottom-0 left-0 w-full h-[56px] bg-gradient-to-r from-[#0088FA] to-[#686868] flex items-center justify-center text-sm">
        <span className="font-montserrat font-bold text-[#686868] text-[16px] leading-[100%] tracking-[0%] align-bottom">
          All rights reserved. @2021-2024
        </span>
        <span className="font-montserrat font-bold text-black text-[16px] leading-[100%] tracking-[0%] align-bottom ml-1">
          Minders
        </span>
      </footer>
    </section>
